        ...
        >
          ...
          <div className="space-y-3 mb-6">
            ...
            <motion.button
              ...
              className="w-full px-6 py-3 rounded-xl border border-neutral-300 dark:border-neutral-700 bg-[#5865F2] text-white font-medium hover:bg-[#4752C4] transition-colors duration-200 flex items-center justify-center gap-3"
            >
            ...
            <motion.button
              ...
              className="w-full px-6 py-3 rounded-xl border border-neutral-300 dark:border-neutral-700 bg-neutral-900 dark:bg-white text-white dark:text-neutral-900 font-medium hover:bg-neutral-800 dark:hover:bg-neutral-100 transition-colors duration-200 flex items-center justify-center gap-3"
            >
              <svg className="w-5 h-5" viewBox="0 0 24 24" fill="currentColor">
          ...
          >
            ...
            <button
              type="submit"
              disabled={submitting}
              className="w-full px-6 py-3 rounded-xl bg-neutral-900 dark:bg-white text-white dark:text-neutral-900 font-medium hover:bg-neutral-800 dark:hover:bg-neutral-200 transition-colors duration-200 disabled:opacity-50"
            >
          ...
          >
            <a
              href="#"
              className="block text-sm text-amber-600 dark:text-amber-400 hover:text-amber-700 dark:hover:text-amber-300 font-medium transition-colors no-underline"
            >
              Forgot password?
            </a>
