  ...
  return (
    <div className="h-screen w-full flex overflow-hidden bg-background">
      ...
      <div className="hidden lg:flex lg:w-1/2 relative bg-background">
        ...
        />
        <div className="relative z-10 w-full p-12 flex flex-col justify-between pointer-events-none">
          <motion.a
            href="/"
            initial={{ opacity: 0, y: -20 }}
            animate={{ opacity: 1, y: 0 }}
            transition={{ duration: 0.5, delay: 0.2 }}
            className="flex items-center gap-3 pointer-events-auto bg-background/80 backdrop-blur-sm px-3 py-2 -mx-3 -my-2 w-fit"
          >
            <img src="/logos/bloxsmith-icon.svg" alt="Bloxsmith" className="h-8 w-8" />
            <img src="/logos/bloxsmith-wordmark.svg" alt="Bloxsmith" className="h-5" />
          </motion.a>
          ...
          <motion.div
            ...
            className="bg-background/80 backdrop-blur-sm px-4 py-4 -mx-4 -my-4 w-fit"
          >
            ...
            <p className="text-muted-foreground text-sm mt-3">
              Generate production-ready UI from text descriptions
            </p>
          </motion.div>
        </div>
      </div>
      ...
      <div className="w-full lg:w-1/2 flex items-center justify-center p-6 sm:p-8 lg:p-12">
        ...
        >
          ...
          <div className="flex items-center gap-2 mb-8 lg:hidden">
            ...
            <img src="/logos/bloxsmith-wordmark.svg" alt="Bloxsmith" className="h-4" />
          </div>
          ...
          {!confirmationSent && (
            <>
              ...
              >
                <div>
                  <input
                    ...
                    placeholder="Email"
                    required
                    className="w-full px-4 py-3 rounded-none border border-border bg-card text-foreground placeholder:text-muted-foreground focus:outline-none focus:ring-1 focus:ring-foreground focus:border-foreground transition-all duration-200"
                  />
                </div>
                ...
                <div className="relative">
                  <input
                    ...
                    required
                    className="w-full px-4 py-3 pr-12 rounded-none border border-border bg-card text-foreground placeholder:text-muted-foreground focus:outline-none focus:ring-1 focus:ring-foreground focus:border-foreground transition-all duration-200"
                  />
                  <button
                    type="button"
              ...
              >
                <a
                  href="#"
                  className="block text-sm text-muted-foreground hover:text-foreground font-medium transition-colors no-underline"
                >
                  Forgot password?
                </a>
                <p className="text-sm text-muted-foreground">
