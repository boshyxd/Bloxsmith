...
const items = [
  {
    ...
    description:
      "Choose from curated design systems built from real production Roblox games. Cartoony, Modern Flat, Anime, and more.",
    images: [
  ...
  },
  {
    ...
    description:
      "One-click import via our free Studio plugin. Export as Luau code, .rbxmx, or auto-publish directly to your live game.",
    images: [
